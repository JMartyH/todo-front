<template>
    <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden my-4">
      <div class="px-6 py-4">
        <div class="flex gap-10 p-16 justify-between items-center border-b border-black">
        ...
        <ul>
          <li v-for="todo in todos" :key="todo.id" class="flex flex-col p-2 border-b border-gray-200 cursor-pointer" @click="editTodo(todo)">
